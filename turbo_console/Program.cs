        ...
        */
        ...
        public static async Task Main(string[] args) {
            ...
            */
            ...
            var connectionString = "Host=db-postgresql-fra1-84481-do-user-12937726-0.b.db.ondigitalocean.com; Port=25060; Database=defaultdb; Username=doadmin; Password=AVNS_uTEbthnjL3Ye4PYQIYR; SslMode=Require; Trust Server Certificate=true";
                        ...
                        try
                        {
                            using (HttpClient apiClient = new HttpClient())
                            {
                                ...
                                if(freshExists || priceCheckExists)
                                {
                                    ...
                                    apiClient.PostAsJsonAsync($"https://api.telegram.org/bot1944346895:AAHAsD_y3SVKL3hx79hD6B-kC_U1MJT2AwA/sendMessage", body).GetAwaiter().GetResult();
                                }
                            }
